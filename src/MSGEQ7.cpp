/**
 * This module isn't used; I ended up deciding not to go with the MSGEQ7 module and use a regular mic with FFT instead.
 * Keeping it around for reference though.
 */
#include <Arduino.h>
#include <MD_MSGEQ7.h> 
